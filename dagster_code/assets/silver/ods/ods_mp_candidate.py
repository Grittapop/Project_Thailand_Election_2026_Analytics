...
def ods_mp_candidate(context, cleaned_mp_candidate):

    df = cleaned_mp_candidate
    ...
    try:
        # Idempotent delete
        cursor.execute(f"""
            DELETE FROM iceberg.silver.ods_mp_candidate
        ...
        for i in range(0, len(rows), BATCH_SIZE):
            ...
            sql = f"""
                INSERT INTO iceberg.silver.ods_mp_candidate
                VALUES {values_sql}
            """
