...
def ods_constituency(context, cleaned_constituency):

    df = cleaned_constituency
    ...
    try:
        # Idempotent delete
        cursor.execute(f"""
            DELETE FROM iceberg.silver.ods_constituency
        ...
        for i in range(0, len(rows), BATCH_SIZE):
            ...
            sql = f"""
                INSERT INTO iceberg.silver.ods_constituency
                VALUES {values_sql}
            """
